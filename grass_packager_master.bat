...
C:\msys64\usr\bin\bash.exe .\grass_osgeo4w.sh  64 79
REM C:\msys32\usr\bin\bash.exe .\grass_rev_info.sh 32 73
C:\msys64\usr\bin\bash.exe .\grass_rev_info.sh 64 79
...
C:\msys64\usr\bin\bash.exe .\grass_md5sum.sh 64 79

REM
echo Building addons...
REM
REM C:\msys32\usr\bin\bash.exe .\grass_addons.sh 32
C:\msys64\usr\bin\bash.exe .\grass_addons.sh 64 79
